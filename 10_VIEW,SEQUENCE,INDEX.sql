...
--> 계정명이 언급되는 상황에서 이 구문 반드시 실행!!

-- VIEW 생성 권한 부여
GRANT CREATE VIEW TO kh_gmk;
...
-- DEPT_COPY2 테이블에서 DEPT_ID, LOCATION_ID 칼럼만 이용해서
-- V_DCOPY2 VIEW 생성
...
INSERT INTO V_DCOPY2
VALUES('D0', 'L3');
-- SQL Error [42399] [99999]: ORA-42399: 
...
START WITH 100 -- 시작번호가 100이다.
INCREMENT BY 5 -- NEXTVAL 호출 시 5씩 증가한다.
MAXVALUE 150 -- 증가 가능한 최대값이 150이다.
NOMINVALUE   -- 최소값은 없다.
NOCYCLE      -- 반복 안한다.
...
INSERT INTO TB_TEST 
VALUES(SEQ_TEST_NO.NEXTVAL , '맹구');  -- 135
...
-- 보통 10_30배 차이 (인덱스를 사용한게 훨씬 빠름을 확인)
