...
-- 테이블 생성 시 해당 칼럼에 지정된 DEFAULT 값으로 삽입이 된다! *
...
-- 가입일 -> SYSDATE 로 삽입
INSERT INTO "MEMBER" 
VALUES ('MEM02', 'QWER1234', '김영희', '000306-2254567', SYSDATE);
...
VALUES ('MEM03', '123WDF', '고민규');



-- ** JDBC 에서 날짜를 입력 받았을 때 삽입하는 방법 **
-- '2024-10-15 12:20:30' 이런식으로 문자열이 넘어온 경우...

INSERT INTO "MEMBER" VALUES
('MEM04', 'PASS04', '고길동', '123456-1234567',
...
('MEM02', 'PAS01', '고고민', '01012341234'); 

SELECT * FROM MEMBER2;

--> NEMBER 타입 컬럼에 데이터 삽입 시
...
CREATE TABLE USER_USED_NN(
	USER_NO NUMBER NOT NULL, -- 사용자 번호 (모든 사용자는 번호가 있어야 한다)
	              --> 컬럼레벨 제약조건 설정
	USER_ID VARCHAR2(20),
...
VALUES(1, 'USER01', 'PASS01', '홍길동', '남자', '010-4354-7890','MDM123@kh.or.kr'); 


INSERT INTO USER_USED_NN 
VALUES(NULL, 'USER01', 'PASS01', '홍길동', '남자', '010-4354-7890','MDM123@kh.or.kr'); 
-- SQL Error [1400] [23000]: 
-- ORA-01400: NULL을 ("KH_GMK"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
CREATE TABLE USER_USED_UK(
	...
	--USER_ID VARCHAR2(20) CONSTRAINTS USER_ID_U UNIQUE -- 컬럼레벨 (제약조건명 지정)
...
-- 무결성 제약 조건(KH_GMK.USER_ID_U)에 위배됩니다

INSERT INTO USER_USED_UK 
VALUES(1, NULL, 'PASS01', '홍길동', '남자', '010-4354-7890','MDM123@kh.or.kr'); 
...
INSERT INTO USER_USED_UK2 
VALUES(2, 'USER02', 'PASS02', '홍길동', '남자', '010-4354-7890','MDM123@kh.or.kr'); 

INSERT INTO USER_USED_UK2 
VALUES(3, 'USER01', 'PASS02', '고길동', '남자', '010-4354-7890','MDM123@kh.or.kr'); 

INSERT INTO USER_USED_UK2 
VALUES(1, 'USER01', 'PASS01', '홍길동', '남자', '010-4354-7890','MDM123@kh.or.kr');
-- SQL Error [1] [23000]: ORA-00001: 
-- 무결성 제약 조건(KH_GMK.USER_ID_NAME_U)에 위배됩니다
...
-- 기본키 중복 오류
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_GMK.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK 
VALUES(NULL, 'USER03', 'PASS03', '유관순', '여자', '010-2422-2522','LEEHH123@kh.or.kr'); 
-- 기본키 NULL 이므로 오류!
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_GMK"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다

INSERT INTO USER_USED_PK 
VALUES(2, 'USER03', 'PASS03', '유관순', '여자', '010-2422-2522','LEEHH123@kh.or.kr'); 
...
INSERT INTO USER_USED_PK2 
VALUES(1, 'USER02', 'PASS02', '이순신', '남자', '010-4354-7890','LEE123@kh.or.kr'); 

INSERT INTO USER_USED_PK2 
VALUES(2, 'USER01', 'PASS02', '이순신', '남자', '010-4354-7890','LEE123@kh.or.kr'); 

INSERT INTO USER_USED_PK2 
VALUES(1, 'USER01', 'PASS01', '홍길동', '남자', '010-4354-7890','MDM123@kh.or.kr'); 
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_GMK.PK_USERNO_USER_ID)에 위배됩니다
-- USER_NO, USER_ID 둘 다 중복되었을 때만 제약조건 위배 에러 발생!

INSERT INTO USER_USED_PK2 
VALUES(NULL, 'USER03', 'PASS01', '홍길동', '남자', '010-4354-7890','MDM123@kh.or.kr'); 
-- SQL Error [1400] [23000]: 
-- ORA-01400: NULL을 ("KH_GMK"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다

INSERT INTO USER_USED_PK2 
VALUES(3, NULL, 'PASS01', '홍길동', '남자', '010-4354-7890','MDM123@kh.or.kr'); 
--SQL Error [1400] [23000]: 
--ORA-01400: NULL을 ("KH_GMK"."USER_USED_PK2"."USER_ID") 안에 삽입할 수 없습니다
...
CREATE TABLE USER_USED_FK(
	USER_NO NUMBER PRIMARY KEY, -- 사용자 번호(고유한 번호 : 중복X / NULL X)
	...
	GRADE_CODE NUMBER CONSTRAINT GRADE_CODE_FK REFERENCES USER_GRADE /*(GRADE_CODE)*/ --컬럼 레벨
	                                      -- 컬럼명 미작성 시 GRADE_CODE 테이블의 PK를 자동참조
...
VALUES(1, 'USER01', 'PASS01', '홍길동', '남자', '010-4354-7890','hong123@kh.or.kr', 10); 
-- USER_GRADE (부모테이블/참조테이블)에 10 이라는 GRADE_CODE가 존재하므로 가능
...
INSERT INTO USER_USED_FK 
VALUES(3, 'USER03', 'PASS03', '유관순', '여자', '010-3333-3333','yoo123@kh.or.kr', 30); 
-- USER_GRADE (부모테이블/참조테이블)에 30 이라는 GRADE_CODE가 존재하므로 가능

INSERT INTO USER_USED_FK 
VALUES(4, 'USER04', 'PASS04', '안중근', '남자', '010-4444-4444','ahn123@kh.or.kr', NULL); 
-- NULL 사용 가능

INSERT INTO USER_USED_FK 
VALUES(5, 'USER05', 'PASS05', '윤봉길', '남자', '010-5555-5555','yoon123@kh.or.kr', 50); 
-- SQL Error [2291] [23000]: ORA-02291: 
-- 무결성 제약조건(KH_GMK.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
...
-- FOREIGN KEY로 지정된 칼럼에서 사용되고 있는 값이 경우
-- 제공하는 컬럼의 값은 삭제하지 못함

DELETE FROM USER_GRADE WHERE GRADE_CODE = 30;
-- SQL Error [2292] [23000]: ORA-02292: 
-- 무결성 제약조건(KH_GMK.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
VALUES(1, 'USER01', 'PASS01', '홍길동', '남자', '010-4354-7890','hong123@kh.or.kr'); 
-- SQL Error [2290] [23000]: ORA-02290: 체크 제약조건(KH_GMK.GENDER_CHECK)이 위배되었습니다

INSERT INTO USER_USED_CHECK 
VALUES(1, 'USER01', 'PASS01', '홍길동', '남', '010-4354-7890','hong123@kh.or.kr'); 
-- 가능

INSERT INTO USER_USED_CHECK 
VALUES(3, 'USER03', 'PASS03', '유관순', '여', '010-3333-3333','yoo123@kh.or.kr'); 
-- 가능
