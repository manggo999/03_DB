...
-- 단, 칼럼의 순서를 지켜서 VALUES에 값을 기입해야함.
SELECT * FROM EMPLOYEE2;

INSERT INTO EMPLOYEE2
VALUES('900', '고민규', '123456-1234567', 'goh_mk@or.kr', '01012341234', 'D1',
...
-- 선택 안된 컬럼은 값이 NULL이 들어감(DEFAULT 존재 시 DEFAULT 설정한 값으로 삽입됨)
...
SELECT * FROM EMPLOYEE2
WHERE EMP_ID = 900; -- 조회 다시해봄(영구저장 되었기 때문에 롤백한다 하더라도 되돌리기 안된다)
